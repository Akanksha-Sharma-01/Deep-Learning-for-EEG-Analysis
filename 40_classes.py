...
model.summary()
history = model.fit(TrainData, TrainLabel, batch_size=20, epochs=15, validation_split=0, validation_data=(TestData, TestLabel),verbose = 2)#, callbacks=my_callbacks)
model.save("/home/arnav/Desktop/Akanksha/40ClassModel1Transformer15Epoch.h5")
