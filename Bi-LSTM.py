...
Original file is located at
    https://colab.research.google.com/drive/1Qds8F-_HcE0TzUlkFpJMVUO3zVtXdtF3
"""
...
def encoder(input):
	...
	x = tf.keras.layers.Bidirectional(layers.LSTM(15, return_sequences=True),input_shape=(30, 25))(x)
	x = tf.keras.layers.Bidirectional(layers.LSTM(15))(x)
